...
export function PayrollScreen({ side }: { side: "factory" | "warehouse" }) {
  ...
  const table = (): ExportTable => ({
    title: `${side === "warehouse" ? "Warehouse" : "Factory"} Staff Payroll`,
  ...
  return (
    <>
      <Topbar
        title={side === "warehouse" ? "Warehouse - Staff Payroll" : "Factory - Staff Payroll"}
        subtitle="Earned, paid, and what is still owed" />
