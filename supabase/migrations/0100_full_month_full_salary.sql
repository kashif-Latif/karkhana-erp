-- 0100_full_month_full_salary.sql
--
...
as $function$
  with bounds as (
    select make_date(p_year, p_month, 1) as first_day,
           ...
           /* The divisor: how many days this month actually has. A full month
              worked then pays exactly the salary, in February as in August. */
...
-- ===========================================================================
-- VERIFY — every figure MOVES, because August has 31 days and was being
-- divided by 30. Each person now earns slightly less for August and exactly
-- their salary for any month they work in full.
--
--   Hamza Khan   gross 54,083 -> 52,339
--   Abdul Rehman gross 58,967 -> 57,065
--
-- Old comment, kept for the arithmetic it describes: Hamza Khan came to 25,083 on 28 counted days, matching
