...
export default function CatalogPage() {
  ...
  useEffect(() => {
    ...
    // categories can only be added to materials that HAVE categories
  ...
  return (
    <>
      <Topbar title="Catalog" subtitle="Materials, their items, and the shared building blocks" />
      <div className="px-6 pb-10">
        {!isSupabaseConfigured ? (
          <div className="rounded-card bg-surface p-8 text-center text-[14px] text-muted shadow-card">Connect Supabase to manage the catalog.</div>
        ) : (
          <>
