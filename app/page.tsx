...
export default function Dashboard() {
  ...
  // Real auth gate switches on automatically once Supabase keys exist.
  useEffect(() => {
      ...
      <main className="min-w-0 flex-1">
        ...
        {!isSupabaseConfigured && (
          <div className="mx-6 mb-4 rounded-xl2 border border-amber-strong/30 bg-amber-soft px-4 py-2.5 text-[12.5px] text-ink/80">
            Preview mode — showing sample data. Add your Supabase keys to switch on
            live data and real logins.
          </div>
        )}
